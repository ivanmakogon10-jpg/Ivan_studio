...
const SHOWCASE = {
  ...
  phone: {
    ...
    screen: [[1642.9, 287.2], [1845.8, 260.2], [1762.7, 819.6], [1536.7, 797.7]]
  },
...
/* =============================================================
   ...
   1. Поднимите обработчик, который принимает POST с JSON.
      Подойдёт serverless-функция Vercel / Netlify / Cloudflare,
      Yandex Cloud Function или любой свой скрипт на сервере.
   2. Внутри обработчика уже безопасно обращаться к Telegram Bot API,
      почте или CRM — токен остаётся на сервере.
   3. Впишите адрес обработчика в BRIEF_ENDPOINT ниже.

   Пока BRIEF_ENDPOINT пуст, форма честно сообщает, что приём
   заявок ещё не подключён, и предлагает написать напрямую.
   ============================================================= */
const BRIEF_ENDPOINT = null;   // например: 'https://ivan-studio.vercel.app/api/brief'
